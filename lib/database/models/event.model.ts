...
export interface IEvent extends Document {
    _id:string;
    // _id is a unique identifier for each event document, automatically generated by MongoDB.
    // It is of type string, which is the default type for MongoDB ObjectId in Mongoose....so we have to include it int the interface.
    title: string;
    description?: string;
    location?: string;
    createdAt: Date;
